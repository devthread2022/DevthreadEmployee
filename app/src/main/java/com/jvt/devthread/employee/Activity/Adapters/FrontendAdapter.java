...
import com.jvt.devthread.employee.Feature.UpdateFrontendStatus;
...
public class FrontendAdapter extends RecyclerView.Adapter<FrontendAdapter.ViewHolder> {
    ...
    public FrontendAdapter(Context context, List<OrderModel> orderModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.update.setOnClickListener(view -> {
            ...
            Common.orderId = orderModelList.get(position).getOrderId();
            Common.empName = orderModelList.get(position).getAssignedTo();
            Fragment update = new UpdateFrontendStatus();
