...
import com.jvt.devthread.employee.Activity.Adapters.LeaveHistoryAdapter;
import com.jvt.devthread.employee.Activity.Model.LeaveModel;
import com.jvt.devthread.employee.R;
import com.jvt.devthread.employee.databinding.FragmentLeaveHistoryBinding;

import java.util.ArrayList;
import java.util.List;

public class LeaveHistory extends Fragment {
    private FragmentLeaveHistoryBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.child("Employees").child(uid).child("AppliedLeave").addValueEventListener(new ValueEventListener() {
            @Override
