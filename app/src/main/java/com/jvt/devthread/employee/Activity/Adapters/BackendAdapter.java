...
import com.jvt.devthread.employee.Feature.UpdateBackendStatus;
import com.jvt.devthread.employee.Feature.UpdateDeploymentStatus;
import com.jvt.devthread.employee.Feature.UpdateUXStatus;
import com.jvt.devthread.employee.R;

import java.util.List;

public class BackendAdapter extends RecyclerView.Adapter<BackendAdapter.ViewHolder> {
    public Context context;
    private List<OrderModel> orderModelList;

    public BackendAdapter(Context context, List<OrderModel> orderModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.update.setOnClickListener(view -> {
            ...
            Common.orderId = orderModelList.get(position).getOrderId();
            Common.empName = orderModelList.get(position).getAssignedTo();
            Fragment update = new UpdateBackendStatus();
