...
import com.jvt.devthread.employee.Feature.UpdateTestingStatus;
...
public class TestingAdapter extends RecyclerView.Adapter<TestingAdapter.ViewHolder> {
    ...
    public TestingAdapter(Context context, List<OrderModel> orderModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.update.setOnClickListener(view -> {
            ...
            Common.orderId = orderModelList.get(position).getOrderId();
            Common.empName = orderModelList.get(position).getAssignedTo();
            Fragment update = new UpdateTestingStatus();
